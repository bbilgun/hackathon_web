        ...
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            <FeatureBlock
              title={
                <Heading
                  content="Sys&CoTech клуб"
                  {...title}
                />
              }
              description={
                <Text
                  content="Бид байгуулагдсан цагаасаа хойш хамтдаа маш олон зүйлсийг хийж бүтээж гайхалтай дурсамжуудыг бий болгосон бидний амьдралын хамгийн сайхан мөч"
                  {...description}
                />
              }
            />
          ...
          <Box className='col' {...col}>
            <CounterUpArea>
              <Card className='card' {...cardStyle}>
                ...
                <Text content='Идэвхтэн гишүүд' />
              </Card>
              <Card className='card' {...cardStyle}>
                <h3>
                  <CountUp start={0} end={70} duration={5} />+
                </h3>
                <Text content='Sys&CoTech гэх том гэр бүл нийт гишүүд' />
              </Card>
              <Card className='card' {...cardStyle}>
                <h3>
                  <CountUp start={0} end={90} duration={5} />+
                </h3>
                <Text content='Хамтын бүтээл, үйл ажиллагаа' />
              </Card>
              <Card className='card' {...cardStyle}>
                <Text content='& илүү их зүйлсийг' />
                <Link href='#'>
                  <a>БҮТЭЭСЭН</a>
                </Link>
              </Card>

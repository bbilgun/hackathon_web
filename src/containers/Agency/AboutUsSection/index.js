...
import GroupImage1 from 'common/assets/image/agency/group/group-image1.png';
import GroupImage2 from 'common/assets/image/agency/group/group-image2.png';
import GroupImage3 from 'common/assets/image/agency/group/group-image3.png';
    ...
    <AboutUsSectionWrapper id="AboutUsSection">
      <Box className="row" {...row}>
        ...
        <Box className='col' {...col}>
          <Box {...textArea}>
            <FeatureBlock
              title={<Heading content='Sys&CoTech хамт олон' {...title} />}
              description={
                <Text
                  content='Бид үргэлж шинийг илэрхийлж, тасралтгүй хөгжин суралцаж өчигдрөөс илүү байхыг зорьдог.'
                  {...description}
                />
              }
            />

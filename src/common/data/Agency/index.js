...
const data = {
  ...
  aboutus: [
    {
      id: 1,
      title: `Клубийн нэрэмжит өрсөлдөөнт програмчлалын тэмцээнийг ${
        thisYear - 2009
      } дах жилдээ`,
      icon: "flaticon-next",
    },
    {
      id: 2,
      title: `Шинэ санаа, шийдлийг танилцуулах Hackathon хөгжүүлэлтийн тэмцээн ${
        thisYear - 2016
      } дах жилдээ`,
      icon: "flaticon-next",
    },
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Бусад оюутан сурагчдад туслах, дэмжих үндсэн үүргээ биелүүлэн манлайлалын үлгэр жишээ болно",
    },
    {
      id: 5,
      ...
      title: "Сургалт",
      description:
        "Шинийг сурах, сурснаа клубийн дотоод гишүүд болон бусдад түгээж хамтдаа хөгжинө",
    },
    {
      id: 6,
      ...
      title: "Шинэлэг байх",
      description:
        "Клубийн үндсэн үйл ажиллагааг улам томруулж хөгжүүлэхийн тулд үргэлж шинээр сэтгэх бүтээхийг хүснэ",
    },
  ],
  qualityFeature: [
    {
